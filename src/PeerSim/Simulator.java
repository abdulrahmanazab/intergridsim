...
/**
 * If present, run the configuration related to this application
 *  @author Azab  
 */
public static final String PAR_APLLICATION = "simulation.application";
...
/**
 * Configure the application type (e.g. Grid)
 * @Author Azab
 */
public static void ConfigApplication(){
    
    if (Configuration.contains(PAR_APLLICATION)){
        
        String applicationName = Configuration.getString(PAR_APLLICATION);
        
        if( applicationName.equals("grid")){
